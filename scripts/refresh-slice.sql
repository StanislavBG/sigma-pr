...
-- Guard composite EIKs the split could not decompose (see normalize-raw.sql): a ';'-bearing member
-- is not a real single authority and must not seed a member row or an orphan 'auth:EIK1; EIK2'.
